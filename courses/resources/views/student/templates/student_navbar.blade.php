...
<nav class="navbar navbar-expand-lg  fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item ">
            <a class="nav-link  active" aria-current="page" href="{{ route('student_index') }}">Home</a>
        </li>
        <li >
            <a class="nav-link " href="{{ route('student_all_projects') }}">Projects</a>
        </li>
        <!-- <li class="nav-item ">
            <a class="nav-link  " href="#">How it Works</a>
        </li> -->
        <li class="nav-item  ">
            <a class="nav-link" href="{{ route('student_about') }}">About Us</a>
        </li>
        <li class="nav-item  ">
            <a class="nav-link" href="{{ route('student_contact') }}">Contact</a>
        </li>
